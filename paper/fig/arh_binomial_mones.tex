\begin{tikzpicture}
    ...
    {
        \edef\temp{
            \noexpand\addplot[fill opacity=0.5,\c] table [x expr=-1*\noexpand\thisrow{mu_o_1}, y expr=-1*\noexpand\thisrow{mu_o_5}, col sep=comma] {data/mones/arh/binomial/interpolated/budget_\b.csv};
        }
        \temp
    }
    ...
    {
        \edef\temp{
            \noexpand\addplot[name path=upper\b, draw=none] table [x expr=-1*\noexpand\thisrow{mu_o_1}, y expr=-1*\noexpand\thisrow{mu_o_5}+\noexpand\thisrow{std_o_5}, col sep=comma] {data/mones/arh/binomial/interpolated/budget_\b.csv};
