\begin{tikzpicture}
    \pgfplotsset{
        ...
        \nextgroupplot[title=$\text{PCN}_{b=2}$]
        ...
        \label{d_new}
        \nextgroupplot[title=$\text{PCN}_{b=3}$]
        ...
        \nextgroupplot[title=$\text{PCN}_{b=4}$]
        ...
        \nextgroupplot[title=$\text{PCN}_{b=5}$]
        ...
        \nextgroupplot[title=$\text{PCN}_{b=\infty}$]
